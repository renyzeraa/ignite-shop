...
export function Product({ title, price, imgSrc, href }: ProductProps) {
    return (
        <Link href={href} className='keen-slider__slide bg-gradient rounded-lg cursor-pointer group relative overflow-hidden flex items-center justify-center' prefetch={false}>
